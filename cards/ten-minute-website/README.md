...
> ✨ 帮你完成一个想法 · 难度：入门 · 适合：人人 / Airbnb 房东 · 约 4 个实验
...
- 大模型读过海量网页代码，你说“一个介绍我 Airbnb 房源的单页，顶部大图、房间列表、评价、地图、一个预订按钮”，它就**生成对应的 HTML/CSS/JS（或 React）**。
...
## 怎么复现（自己做）
1. **最快（无代码）**：Google AI Studio → Build，一句话描述你的 Airbnb 房源单页，让它生成 React 应用；替换成你的照片/文案，导出或部署。
